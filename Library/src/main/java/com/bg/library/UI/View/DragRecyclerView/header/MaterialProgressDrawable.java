...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        DragLocalDisplay.init(mParent.getContext());
        final int shadowYOffset = DragLocalDisplay.dp2px(Y_OFFSET);
        final int shadowXOffset = DragLocalDisplay.dp2px(X_OFFSET);
        int mShadowRadius = DragLocalDisplay.dp2px(SHADOW_RADIUS);
