...
public abstract class DragDefaultHandler implements DragHandler {
...
//              return view.getScrollY() > 0;
     ...
     * @return
     */
    public static boolean checkContentCanBePulledDown(DragFrameLayout frame, View content, View header) {
