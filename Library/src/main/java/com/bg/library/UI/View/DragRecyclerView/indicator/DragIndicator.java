package com.bg.library.UI.View.DragRecyclerView.indicator;
...
public class DragIndicator {
    ...
    public void convertFrom(DragIndicator dragSlider) {
        mCurrentPos = dragSlider.mCurrentPos;
        mLastPos = dragSlider.mLastPos;
        mHeaderHeight = dragSlider.mHeaderHeight;
    }
