package com.bg.library.UI.View.DragRecyclerView.header;
...
import com.bg.library.UI.View.DragRecyclerView.DragUIHandler;
import com.bg.library.UI.View.DragRecyclerView.indicator.DragIndicator;
import com.bg.library.UI.View.DragRecyclerView.utils.DragLocalDisplay;

import java.util.ArrayList;

public class StoreHouseHeader extends View implements DragUIHandler {
    ...
    private void initView() {
        DragLocalDisplay.init(getContext());
        mLineWidth = DragLocalDisplay.dp2px(1);
        mDropHeight = DragLocalDisplay.dp2px(40);
        mHorizontalRandomness = DragLocalDisplay.SCREEN_WIDTH_PIXELS / 2;
    }
    ...
    private int getTopOffset() {
        return getPaddingTop() + DragLocalDisplay.dp2px(10);
    }

    private int getBottomOffset() {
        return getPaddingBottom() + DragLocalDisplay.dp2px(10);
    }
    ...
    public void initWithPointList(ArrayList<float[]> pointList) {
        ...
        for (int i = 0; i < pointList.size(); i++) {
            ...
            PointF startPoint = new PointF(DragLocalDisplay.dp2px(line[0]) * mScale, DragLocalDisplay.dp2px(line[1]) * mScale);
            PointF endPoint = new PointF(DragLocalDisplay.dp2px(line[2]) * mScale, DragLocalDisplay.dp2px(line[3]) * mScale);
    ...
    public void onUIPositionChange(DragFrameLayout frame, boolean isUnderTouch, byte status, DragIndicator dragIndicator) {
        ...
        float currentPercent = Math.min(1f, dragIndicator.getCurrentPercent());
